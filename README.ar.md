...
- [🚀 التكامل مع الذكاء الاصطناعي](#-التكامل-مع-الذكاء-الاصطناعي--الوقود-المثالي-لمنتجات-ai)
  - [📂 مجلد AI_INSTRUCTIONS](#-مجلد-ai_instructions--سياق-جاهز-لمساعدي-ai)
...
### 📂 مجلد AI_INSTRUCTIONS — سياق جاهز لمساعدي AI

يتضمن المستودع مجلدًا مخصصًا **[AI_INSTRUCTIONS](AI_INSTRUCTIONS/)** يحتوي على كل ما يحتاجه مساعدو البرمجة بالذكاء الاصطناعي للعمل بفعالية مع هذه الأدوات.
...
```bash
# يقرأ مساعدو AI تلقائيًا AI_INSTRUCTIONS عند العمل مع المستودع
# أو وجههم مباشرة:
"اقرأ AI_INSTRUCTIONS/CLAUDE.md وساعدني في إنشاء خط أنابيب تحويل دفعي"
```
