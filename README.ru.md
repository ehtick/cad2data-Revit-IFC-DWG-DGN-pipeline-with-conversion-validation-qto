...
- [🚀 Интеграция с ИИ](#-интеграция-с-ии--идеальное-топливо-для-ии-продуктов)
  - [📂 Папка AI_INSTRUCTIONS](#-папка-ai_instructions--готовый-контекст-для-ии-ассистентов)
...
### 📂 Папка AI_INSTRUCTIONS — Готовый контекст для ИИ-ассистентов

Репозиторий содержит специальную папку **[AI_INSTRUCTIONS](AI_INSTRUCTIONS/)** со всем необходимым для эффективной работы ИИ-ассистентов с этими инструментами.
...
**Как использовать:**
```bash
# ИИ-ассистенты автоматически читают AI_INSTRUCTIONS при работе с репозиторием
# Или направьте их напрямую:
"Прочитай AI_INSTRUCTIONS/CLAUDE.md и помоги создать пайплайн пакетной конвертации"
```
...
**→ [Изучить 196 DDC Skills](https://github.com/datadrivenconstruction/DDC_Skills_for_AI_Agents_in_Construction)**
